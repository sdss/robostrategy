...
class AssignmentStatus(object):
    ...
    bright_neighbor : ndarray of bool
        would this cause an issue with a bright neighbor (initialized to False)
...
"""
    def __init__(self, rsid=None, robotID=None, iexps=None):
        ...
        self.bright_neighbor = np.zeros(len(self.iexps), dtype=bool)
...
"""
    def __init__(self, filename=None, racen=None, deccen=None, pa=0.,
                 ...
                 bright_neighbors=False, verbose=False, veryverbose=False):
...
"""
    ...
    def set_bright_neighbor_status(self, status=None, iexp=None):
        ...
        status.bright_neighbor[i] = self.bright_neighbor_cache[key]
        return
